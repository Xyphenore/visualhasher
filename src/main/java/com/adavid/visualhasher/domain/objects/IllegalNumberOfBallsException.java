...
/**
 * Thrown to indicate that the Box's constructor or setter received an illegal number of balls.
 *
 * @author Axel DAVID
 * @version 1.0.0
 * @see Box
 * @since 1.0.0
 */
public final class IllegalNumberOfBallsException extends IllegalArgumentException {
