 ...
 * @since 1.0.0
 */
public final class LinearOpenAddressingHashFunctionWorker extends SwingWorker<Void, HashFunctionIntermediaryResult> {
     ...
     * @since 1.0.0
     */
    public LinearOpenAddressingHashFunctionWorker(
    ...
    private LinearOpenAddressingHashFunctionWorker() {
        throw new UnsupportedOperationException(
                "Cannot create a LinearOpenAddressingHashFunctionWorker without the number of box, and the number of draws. Please call a public constructor with the number of box, and the number of draws.");
    }
