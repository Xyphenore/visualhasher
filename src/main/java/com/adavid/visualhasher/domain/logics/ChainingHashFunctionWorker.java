 ...
 * @since 1.0.0
 */
public final class ChainingHashFunctionWorker extends SwingWorker<Void, HashFunctionIntermediaryResult> {
     ...
     * @since 1.0.0
     */
    public ChainingHashFunctionWorker(
    ...
    protected Void doInBackground() {
        ...
        this.finalInformation = generateInformation(this.maxBalls, this.maxBoxesIndexes);
