...
import com.adavid.visualhasher.infrastructure.configuration.Configuration;
import com.adavid.visualhasher.presentation.components.futures.helpmenu.AboutMenuItem;
import com.adavid.visualhasher.presentation.components.futures.helpmenu.HelpMenu;
import com.adavid.visualhasher.presentation.components.futures.locales.LocaleMenu;
        ...
        about.addActionListener((final ActionEvent event) -> {
            if ("about".equals(event.getActionCommand())) {
                ...
                final var information = new JTextArea(
                        "Show the repartition of different hash functions for a customizable number of box and number of draws.");
