...
import com.adavid.visualhasher.domain.objects.IllegalBoxIDException;
import com.adavid.visualhasher.domain.objects.IncrementableBox;
import com.adavid.visualhasher.domain.objects.ResettableBox;
 ...
 * @since 1.0.0
 */
public class CommonBaseBox extends JPanel implements ResettableBox, IncrementableBox {
    @Serial
    ...
    public final void decrementBalls() {
        this.balls = Math.decrementExact(this.balls);
        if (0 > this.balls) {
