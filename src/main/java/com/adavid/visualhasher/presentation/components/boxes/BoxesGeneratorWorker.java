...
public final class BoxesGeneratorWorker extends SwingWorker<Void, Integer> {
    private final int boxesNb;
    private final BoxesPanel panel;

    public BoxesGeneratorWorker(final int boxesNb, final BoxesPanel panel) {
        super();
    ...
    protected void process(final List<Integer> chunks) {
        for (final var index : chunks) {
            this.panel.addBox(new ComputationBox(index));
        }
    }
